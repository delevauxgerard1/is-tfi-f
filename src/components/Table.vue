          ...
          <tfoot>
            ...
            <tr>
              <td colspan="6" class="text-right">
                <button @click="realizarVenta" class="px-4 py-2 bg-blue-500 text-white rounded-md">
                  Realizar Venta
                </button>
              </td>
            </tr>
...
const articles = [
    { id: 1, brand: 'Nike', name: 'Zapatillas Air Max', size: '42', color: 'Negro', price: 120, quantity:2 },
    { id: 2, brand: 'Adidas', name: 'Remera Estampada', size: 'M', color: 'Blanco', price: 30 , quantity:3 },
    { id: 3, brand: 'Puma', name: 'Short Deportivo', size: 'L', color: 'Azul', price: 25, quantity: 1 },
    { id: 4, brand: 'Converse', name: 'Zapatillas Chuck Taylor', size: '39', color: 'Rojo', price: 80, quantity:1 },
    { id: 5, brand: 'Vans', name: 'Gorra Clásica', size: 'Único', color: 'Gris', price: 20, quantity:1 },
    { id: 6, brand: 'New Balance', name: 'Sweater Cuello Redondo', size: 'XL', color: 'Verde', price: 50, quantity:1 },
    { id: 7, brand: 'Reebok', name: 'Mochila Deportiva', size: 'Único', color: 'Negro', price: 40 , quantity:2},
    { id: 8, brand: 'Fila', name: 'Pantalón Jogger', size: 'S', color: 'Gris', price: 35, quantity:2 },
    { id: 9, brand: 'Under Armour', name: 'Camiseta Sin Mangas', size: 'M', color: 'Azul', price: 28, quantity:4 },
    { id: 10, brand: 'ASICS', name: 'Zapatillas Gel-Kayano', size: '41', color: 'Blanco', price: 150, quantity:4 },
];
...
const getTotal = () => {
  return articles.reduce((total, article) => total + (article.price * article.quantity), 0).toFixed(2);
};

const realizarVenta = () => {
  // Lógica para realizar la venta
  // Puedes agregar aquí la lógica que necesitas al realizar la venta
};
</script>